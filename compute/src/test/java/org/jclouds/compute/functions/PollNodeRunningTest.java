 ...
 * @author Adrian Cole
 */
@Test(groups = "unit", testName = "PollNodeRunningTest")
public class PollNodeRunningTest {
   ...
   public void testIllegalStateExceptionWhenNodeStillPending() {
      ...
      try {
         ...
         assertEquals(e.getMessage(), "node(id) didn't achieve the status running; aborting after 0 seconds with final status: PENDING");
   ...
   public void testIllegalStateExceptionWhenNodeDied() {
      ...
      try {
         ...
         assertEquals(e.getMessage(), "node(id) terminated");
   ...
   public void testIllegalStateExceptionAndNodeResetWhenRefSetToNull() {
      ...
      try {
         ...
         assertEquals(e.getMessage(), "api response for node(id) was null");
         assertEquals(atomicNode.get(), pendingNode);
      }
   }
